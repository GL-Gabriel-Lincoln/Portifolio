function calculateDeterminant() {
    ...
    var matrix = [
        [document.getElementById('l1c1').value, document.getElementById('l1c2').value, document.getElementById('l1c3').value],
        [document.getElementById('l2c1').value, document.getElementById('l2c2').value, document.getElementById('l2c3').value],
        [document.getElementById('l3c1').value, document.getElementById('l3c2').value, document.getElementById('l3c3').value]
    ];
    ...
    var determinant = matrix[0][0]*(matrix[1][1]*matrix[2][2] - matrix[1][2]*matrix[2][1]) - matrix[0][1]*(matrix[1][0]*matrix[2][2] - matrix[1][2]*matrix[2][0]) + matrix[0][2]*(matrix[1][0]*matrix[2][1] - matrix[1][1]*matrix[2][0]);
